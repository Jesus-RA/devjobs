    ...
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-5 shadow-lg" method="POST" action="{{ route('login') }}" novalidate>
                    @csrf

                    <div class="flex flex-wrap mb-6">
                        <label for="email" class="block text-gray-700 text-sm mb-2">{{ __('E-Mail Address') }}</label>

                        <input id="email" type="email" class="p-3 bg-gray-400 rounded form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ old('email') }}" autocomplete="email" autofocus>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password" type="password" class="p-3 bg-gray-400 rounded form-input w-full @error('password') border-red-500 border @enderror" name="password" autocomplete="current-password">
                    ...
                    <div class="flex flex-wrap mb-6">
                            <div class="form-check">
                                ...
                                <label class="text-gray-700 text-sm mb-2" for="remember">
                                    {{ __('Remember Me') }}
                                </label>
                            </div>
                    </div>
