        ...
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    ...
                    <form class="py-10 px-5 shadow-lg" method="POST" action="{{ route('password.update') }}">
                        @csrf
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="p-3 bg-gray-400 rounded form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password" type="password" class="p-3 bg-gray-400 rounded form-input w-full @error('password') border-red-500 border @enderror" name="password" required autocomplete="new-password">
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password-confirm" type="password" class="p-3 bg-gray-400 rounded form-input w-full" name="password_confirmation" required autocomplete="new-password">
                        </div>
