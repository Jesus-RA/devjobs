...
<div class="container mx-auto max-w-screen-md">
    <div class="flex flex-wrap justify-center">
            ...
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                    <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                        ...
                        <form class="py-10 px-5 shadow-lg" method="POST" action="{{ route('register') }}" novalidate>
                            @csrf
    
                            <div class="flex flex-wrap mb-6">
                                <label for="name" class="block text-gray-700 text-sm mb-2">{{ __('Name') }}</label>
    
                                <input id="name" type="text" class="p-3 bg-gray-400 rounded form-input w-full @error('name') border-red-500 border @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus>
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="email" type="email" class="p-3 bg-gray-400 rounded form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ old('email') }}" autocomplete="email">
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="password" type="password" class="p-3 bg-gray-400 rounded form-input w-full @error('password') border-red-500 border @enderror" name="password" autocomplete="new-password">
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="password-confirm" type="password" class="p-3 bg-gray-400 rounded form-input w-full" name="password_confirmation" autocomplete="new-password">
                            </div>
        ...
        <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
            <h1 class="text-teal-500 text-xl">¿Eres reclutador?</h1>
