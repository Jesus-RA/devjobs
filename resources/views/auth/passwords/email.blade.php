    ...
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-5 shadow-lg" method="POST" action="{{ route('password.email') }}" novalidate>
                    @csrf
                    
                    @if (session('status'))
                        <span class="bg-red-100 border-l-4 border-red-500 text-red-700 text-sm p-4 w-full my-5 block" role="alert">
